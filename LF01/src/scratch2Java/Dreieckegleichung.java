...
public class Dreieckegleichung {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("Geben sie bitte die seiten länge a an:");
		String eingabe = br.readLine();
		double a = Double.parseDouble(eingabe.trim().replace(',', '.'));

		System.out.println("Geben sie bitte die seiten länge b an:");
		eingabe = br.readLine();
		double b = Double.parseDouble(eingabe.trim().replace(',', '.'));

		System.out.println("Geben sie bitte die seiten länge c an:");
		eingabe = br.readLine();
