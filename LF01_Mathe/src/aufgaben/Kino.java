...
public class Kino {
	...
	public static void main(String[] args) throws IOException {
		...
		do {
			System.out.println("sie haben folgende m�glichkeiten: ");
	...
	private static String[][] erzeugenSaal() throws IOException {
		...
		System.out.println("Wie gro� ist Ihre Kinosaal? (Bitte Anzahl der Spalten eingeben) ");
		int spalte = IO.readInteger();
		System.out.println("Wie gro� ist Ihre Kinosaal? (Bitte Anzahl der Reihen eingeben) ");
