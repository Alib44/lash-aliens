...
public class TashenRechnerOhneEingabe {
	...
	public static void main(String[] args) throws IOException {
		...
		if(x>=0 && x<=100) {
			if (y>=0 && y<=100) {
				...
				System.out.println("Brechnung nicht m�glich, da y nicht passend ist!");
			}
		} else {
			System.out.println("Brechnung nicht m�glich, da x nicht passend ist!");
	...
	private static void schreibeMenue() {
		...
		System.out.println("w = Quadratishe W�rzel");
